                    ...
                    <c:when test="${fn:length(list) != 0}">
                        <table class="table table-hover">
                            ...
                            <c:forEach items="${list}" var="info">
                                <tr>
                                    <td>${travelInfo.fromAddress}</td>
                                    <td>${travelInfo.toAddress}</td>
                                    <td>${info.requestName}</td>
                                    <td>${info.time}</td>
                                    <td><a href="AcceptRequest?requestName=${info.requestName}&travelID=${info.travelID}" style="color: #03a9f4">${info.requestName}</a></td>

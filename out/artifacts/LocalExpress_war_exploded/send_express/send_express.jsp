...
<div class="services">
    <div class="container">
        ...
        <div class="contact-top">
            <h1 class="btns">
                <a href="send_express/check_by_search.jsp"><span class="label label-success">搜索</span></a>
            </h1>
            <h1 class="btns">
                &nbsp;&nbsp;<a href="SendExpress?info=all"><span class="label label-success">查看所有行程信息</span></a>
            </h1>
        </div>
    </div>
</div>

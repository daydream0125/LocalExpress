    ...
    <div class="container">
        ...
        <div class="contact-top">
            ...
            <table align="center">
                ...
                用户:<a href="CheckUserInfo?userName=${param.acceptName}">${param.acceptName}</a><br/>

                <form action="UserAssess">
                    <input type="hidden" name="acceptName" value="${param.acceptName}">
                    <select name="userAssess" >
